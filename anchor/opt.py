...
if __name__ == '__main__':
    ...
    # k = 30, a = 1
    # xs = [0.010000735732930893, 0.06728554648775059, 0.02533001000361058, 0.0799974768780288, 0.010002220051112223, -0.69425169936661]

    # k = 30, a = 0.3
    # xs = [0.06537370705668276, 0.023284162574029352, 0.07996217581835618, 0.010672120755835596, 0.01000126926198963, -0.024262242372249054]

    # k = 30, a = 1.5
    # xs = [0.018295119722289917, 0.07171727292477964, 0.01003392620991074, 0.07998059100142357, 0.010010473528214894, 0.526687791272973]
